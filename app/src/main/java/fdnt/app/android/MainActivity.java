...
public class MainActivity extends AppCompatActivity
    ...
    public void dostosujZakładki() {
        ...
        if (dostęp[41]) //41
            nav_Menu.findItem(R.id.nav_skill_trade_club).setVisible(true);
